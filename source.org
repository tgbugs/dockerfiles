...
=dev-python/pypy-exe-7.3.22::gentoo  # hopefully temporary?
#+end_src
...
dev-python/flask-sqlalchemy::tgbugs-overlay
#+end_src
...
# FIXME TEMP cloudpickle bug workaround
dev-python/ttlser -ttlfmt
dev-python/joblib -python_targets_pypy3_11
dev-python/loky -python_targets_pypy3_11
dev-python/cloudpickle -python_targets_pypy3_11
#+end_src
**** env
***** no distcc
# TODO MAKEOPTS_LOCAL
