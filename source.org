# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: 11963bf4a366352fb9dacad87caf35a328d093160c1782dfe4d28e8a86635d5a; -*-
...
dev-haskell/*::haskell
>=dev-lang/rust-1.72  # cc issue https://bugs.gentoo.org/888936
...
dev-python/frozendict::tgbugs-overlay
#+end_src
**** package.use
...
RUN \
{ command -v xdg-user-dirs-update && xdg-user-dirs-update; rmdir Desktop Pictures Documents Public Downloads Templates Music Videos;} || true
...
#+end_src
FIXME completely missing resources in the source
#+begin_src bash
/usr/share/interlex/sql/permissions.sql
/usr/bin/interlex-dbsetup
#+end_src
**** mysql dump
**** sync
**** run
#+header: :shebang "#!/usr/bin/env sh"
#+begin_src bash :tangle ./musl/interlex/entrypoint.sh :mkdirp yes
PG_SLOT=$(eselect postgresql show)
rc-status
touch /run/openrc/softlevel
...
;  rmdir Desktop Pictures Documents Public Downloads Templates Music Videos
...
RUN \
su "$(id -nu 836)" -c "xdg-user-dirs-update; rmdir Desktop Pictures Documents Public Downloads Templates Music Videos"
