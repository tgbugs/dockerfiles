# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: f019dfa1114b3ed906dcb6130d17df42257716168cf8b90c59b610b88e6b7de9; -*-
...
currently only sbcl static uses this but other things might need it in the future"
  ...
  (let ((sbcl-static-patches-source "<<&helper-repos()>>/sbcl/patches")
    ...
    (copy-directory sbcl-static-patches-source sbcl-static-patches-target 'keep-time 'parents 'copy-contents)))
