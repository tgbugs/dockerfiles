# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--prp-1\.1; orgstrap-block-checksum: 7fd8fcdcf55c3d61cc086dae064e4c4c2a52dd296f57e97923dd15699e509f26; -*-
...
<<&musl-build-profile-nox>> || return $?;
  <<&musl-build-eselect-repo>> || return $?;
    ...
    docker rm local-repos-snap || return $?;
...
*** file
#+begin_src dockerfile :noweb yes :tangle ./docker-profile/base/Dockerfile
...
#+begin_src conf :tangle ./docker-profile/base/docker-profile/profiles/tgbugs/make.defaults :tangle no
VIDEO_CARDS=""
#+end_src
**** mask
...
=app-emacs/vterm-0.0.1_pre20210618 ~amd64
#+end_src
** nox
...
*** file
#+begin_src dockerfile :noweb yes :tangle ./docker-profile/nox/Dockerfile
FROM busybox:latest as builder
...
*** file
#+begin_src dockerfile :noweb yes :tangle ./gnu/profile/Dockerfile
FROM busybox:latest as builder
...
*** etc
**** binrepos.conf
#+begin_src conf :noweb yes :tangle ./gnu/profile/gnu.conf
[tgbugs-gnu]
priority = 100
...
--network host \
--add-host local.binhost:127.0.0.1 \
--file gnu/eselect-repo/Dockerfile .
#+end_src
