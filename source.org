...
su sparc -c 'PYTHONBREAKPOINT=0 celery --app sparcron worker -n wcron -Q cron,default --detach --beat --schedule-filename ./sparcur-cron-schedule --loglevel=INFO'

su sparc -c 'PYTHONBREAKPOINT=0 celery --app sparcron worker -n wexport -Q export --loglevel=INFO'
