...
#+begin_src conf :tangle ./docker-profile/musl/docker-profile/profiles/tgbugs/musl/package.use.force
...
sh -c \
"
mkdir -p /usr/x86_64-pc-linux-musl/etc/portage/package.use/99-sbcl; cp /tmp/99-sbcl /usr/x86_64-pc-linux-musl/etc/portage/package.use/99-sbcl;
