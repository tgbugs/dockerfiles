# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: 3a6728d320bbb8529d37c7f1551f5c477fb9587a485ba9216dfc69e68d7d19c1; -*-
...
-e DISPLAY=$DISPLAY \
-e SCIGRAPH_API=http://localhost:9000/scigraph \
-v ${PWD}/musl/kg-dev-user/test.sh:/etc/entrypoints/test.sh \
--entrypoint /etc/entrypoints/test.sh \
--rm \
-it tgbugs/musl:kg-dev-user
#+end_src
...
(when noninteractive
  (let ((setup (member "setup" argv))
    ...
    (let ((no-screen    (and build (member "--no-screen" argv)))
          ...
          ;;(static       (and build (member "--static" argv)))
