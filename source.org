# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: a7728c5e26ea4f853adbf827f17717299bcfe8b5b01da0a84591584ee5489aa9; -*-
...
(progn
  (message "before")
  (with-error-on-fail
   (execute-src-block "bash-exit-test"))
  (message "after"))
#+end_src
