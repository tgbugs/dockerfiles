...
* other
** bootstrap attempt 3
XXX just stick with tgbugs/musl:docker at this point I think?
...
;; distcc hosts file
  ...
  (let ((bp "~/files/binpkgs"))
    (make-directory (expand-file-name "multi" bp))
    (make-directory (expand-file-name "cross/gnu/x86_64-pc-linux-musl" bp)) ; keep it around just in case
    (make-directory (expand-file-name "cross/gnu/x86_64-gentoo-linux-musl" bp)))
)
