...
ADD docker-profile/base/emacs.env           etc/portage/env/app-editors/emacs
ADD docker-profile/base/no-distcc.env       etc/portage/env/no-distcc
ADD package.env                             etc/portage/package.env/profile
#+end_src
