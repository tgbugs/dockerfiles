# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: 2184f8e97896472284ac224399ddf8eea65e2cee8a5ece2699d5ebb3d55725b6; -*-
        ...
        (when build
          ...
          (let ((package-server-running
                 (condition-case out-err
                     (url-http-file-exists-p (format "http://localhost:<<&host-binpkgs-port()>>/%s/Packages" (file-name-base path-binpkgs)))
                   (file-error
