...
#+end_src
The double slash in =//bin/sh= is to prevent git bash on windows from
rewriting =/bin/sh= -> =C:/Program Files/Git/bin/sh.exe= and failing.
Hacks, hacks all the way down. See https://stackoverflow.com/a/68795519.
