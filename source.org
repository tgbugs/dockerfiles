# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: 986e87117f1d0cf14c0803e79695cc51928cde1d11b681c5882fa424dc5ad6bf; -*-
...
index 5dd320d..7c528d9 100644
--- a/src/patchelf.cc
+++ b/src/patchelf.cc
@@ -1184,10 +1184,6 @@ void ElfFile<ElfFileParamNames>::rewriteHeaders(Elf_Addr phdrAddress)
...
/etc/init.d/blazegraph start
BLAZ_OOPS=$?
[ ${SCIG_OOPS} -ne 0 && ${BLAZ_OOPS} -ne 0 ] || {echo scigraph and blazegraph failed to start; exit 1;}
[ ${SCIG_OOPS} -ne 0 ] || {echo scigraph failed to start; exit 2;}
[ ${BLAZ_OOPS} -ne 0 ] || {echo blazegraph failed to start; exit 3;}
...
&& echo "(setq site-packages '(vterm zmq))" >> init.el \
...
;  cat /var/lib/portage/world | xargs emerge -j4 -q --backtrack=99 -uDN \
<<&archive-or-rm>>
#+end_src
