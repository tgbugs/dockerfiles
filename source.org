# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: 4b748276fde4953578336920f8baf2e34b22f76e60baab8548dd52872bfb9950; -*-
...
local OUT _builder _image _static
container-check
...
if [ -z ${_static} ]; then
_builder=${_tm_pbs}
_image=package-builder
else
_builder=${_tm_s_pbs}
_image=static-package-builder
fi
