...
ADD patches/sbcl-2.6.4-musl-termios.patch /etc/portage/patches/dev-lisp/sbcl-2.6.4/sbcl-2.6.4-musl-termios.patch
#+end_src
*** sets
**** builder
...
Temporary patch to work around https://bugs.launchpad.net/sbcl/+bug/2153432
#+begin_src diff :tangle ./musl/package-builder/patches/sbcl-2.6.4-musl-termios.patch :mkdirp yes
diff --git a/contrib/sb-posix/constants.lisp b/contrib/sb-posix/constants.lisp
index 26a16d36a..98e17bf3d 100644
...
index 416c8ece8..5109262a6 100644
