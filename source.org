...
; elisp-safe-block
(expand-file-name "<<&default-host-binpkgs-root-path()>>")
#+end_src
...
#+begin_src elisp :noweb yes
; elisp-safe-block
(expand-file-name "<<&default-host-distfiles-path()>>")
#+end_src
...
#+begin_src elisp :noweb yes
; elisp-safe-block
(expand-file-name "<<&default-host-distcc-hosts-path()>>")
#+end_src
...
#+begin_src elisp :noweb yes
; elisp-safe-block
(expand-file-name "<<&default-host-ssh-path()>>")
#+end_src
