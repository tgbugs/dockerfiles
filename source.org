...
ADD ${bp}kpathsea-c23.patch                      etc/portage/patches/dev-libs/kpathsea/kpathsea-c23.patch
...
***** dev-libs/kpathsea
Fix not yet merged https://bugs.gentoo.org/952902
#+begin_src diff :tangle ./docker-profile/base/kpathsea-c23.patch
From 90c462d1f353ed516d24bf85fd9d4dd873d21554 Mon Sep 17 00:00:00 2001
From: Michael Orlitzky <michael@orlitzky.com>
Date: Fri, 11 Jul 2025 07:55:55 -0400
Subject: [PATCH] getopt.[ch]: use getopt/getenv declarations from the standard
 headers

These two files go to a lot of trouble to avoid using stdlib.h and
unistd.h except on glibc systems, where the prototypes for getopt and
getenv are known and "as expected." But, the workaround on non-glibc
systems is to declare them as "int getopt()" and "char* getenv()",
which, under C23, declares them incorrectly. In particular it breaks
compilation under musl/gcc-15.

Both of these functions are POSIX, and at least on Gentoo we don't
need to worry about non-standard implementations of basic library
funtions. This commit drops two glibc conditionals, always includes
those headers, and uses whatever prototypes they give us.

Bug: https://bugs.gentoo.org/952902
---
 texk/kpathsea/getopt.c |  7 -------
 texk/kpathsea/getopt.h | 14 +-------------
 2 files changed, 1 insertion(+), 20 deletions(-)

diff --git a/texk/kpathsea/getopt.c b/texk/kpathsea/getopt.c
index 04c1e21c..5d90b3bd 100644
--- a/getopt.c
+++ b/getopt.c
@@ -59,12 +59,8 @@
...
@@ -206,8 +201,6 @@ static char *posixly_correct;
...
index 8acf05fb..65b4aa16 100644
--- a/getopt.h
+++ b/getopt.h
@@ -117,20 +117,8 @@ struct option
...
ADD python-eclass-pypy3_11-fix.patch /tmp/python-eclass-pypy3_11-fix.patch
RUN \
patch -p2 -i /tmp/python-eclass-pypy3_11-fix.patch /var/db/repos/gentoo/eclass/python-utils-r1.eclass
...
#+end_src
*** patches
#+begin_src diff :tangle ./repos/python-eclass-pypy3_11-fix.patch :mkdirp yes
...
@@ -50,7 +51,7 @@ readonly _PYTHON_ALL_IMPLS
