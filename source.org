# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: 3afef52b2b543925c5612e187e81af34ccacc5d7ad3f167f833c744b7f55c0bf; -*-
  ...
  pushd <<&helper-repos()>>
    ...
    pushd sbcl
      ...
      git diff ${tag}..remotes/tgbugs/static-executable-v2-${version} ':(exclude)README*' | \
        sed 'maybetime sh,maybetime sh -x,' > \
        ${ipath}/${patch}
    popd
  popd
fi
