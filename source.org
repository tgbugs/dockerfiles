...
su sparc -c 'PYTHONBREAKPOINT=0 celery --app sparcron worker -n wcron -Q cron,default --concurrency=1 --detach --beat --schedule-filename ./sparcur-cron-schedule --loglevel=INFO'
