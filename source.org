...
#+begin_src bash :tangle ./bin/gnu-cross-musl-sbcl.sh
...
gnu-builder-run \
sh -c 'USE=system-bootstrap x86_64-gentoo-linux-musl-emerge -q -j4 --keep-going dev-lisp/sbcl'
...
Then inside musl =builder-debug=
