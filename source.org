# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: 1b65382a4c2ccb5a6b8f314bf800727d3f6d35e19e2df9896e7458ad00e463fc; -*-
...
docker image inspect tgbugs/repos:latest
NEED_REPOS=$?
...
docker image inspect tgbugs/gnu:package-builder-snap
NEED_RESNAP=$?
...
# first time if the package builder doesn't exist at all we need to create it
docker image inspect tgbugs/musl:package-builder-snap
NEED_RESNAP=$?
if [ ${NEED_RESNAP} -ne 0 ]; then
    RESNAP=1
fi
